...
──────────────────────
おいしく安全な、オーガニック（有機）クッキー
ハニークローバー株式会社 〒108-0074 東京都港区⾼輪4-1-18 ⾼輪ビル4階　
...
<div id="formWrap">
<div class="order">
	<img class="order__cookie1" src="img/order_cookie1.png" alt="クッキー">
	<img class="order__leaf-right1" src="img/order_leaf-right1.png" alt="葉っぱ">
	<img class="order__cookie2" src="img/order_cookie2.png" alt="クッキー">
	<img class="order__leaf-left1" src="img/order_leaf-left1.png" alt="葉っぱ">
	<div class="order__form-title-bg">
        <h2 class="order__form-title">ご注文フォーム</h2>
    </div>
    <p class="order__form-confirm-lead">入力内容に間違いがなければ、<br>送信するボタンにて注文を完了してください。</p>

    <div class="order__form-bg">
		<?php if($empty_flag == 1){ ?>
		<div align="center">
...
<div class="order">
	...
	<img class="order__leaf-left1" src="img/order_leaf-left1.png" alt="葉っぱ">
	<div class="order__form-title-bg">
        <h2 class="order__form-title">ご注文ありがとうございました！</h2>
    </div>
    <p class="order__form-confirm-lead">下記の通りご注文を受け付けました。<br>スタッフより受注確認のご連絡を致しますので、<br class="view-sp">しばらくお待ちくださいませ。</p>
    ...
    <div class="order__form-bg">
		...
		<input type="hidden" name="httpReferer" value="<?php echo h($_SERVER['HTTP_REFERER']);?>">
		<div class="order__wrap-btn">
			<a href="./" class="order__btn-back">
				<span class="order__btn-txt">戻る</span>
			</a>
		</div>
		<?php } ?>
	</div>
